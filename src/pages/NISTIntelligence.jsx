  ...
  return (
    <div className="v2-page" style={{ fontFamily: FONT }}>
      <style>{`
        ...
        .ni-h1 em{color:#2a6b5c;font-style:normal}
        ...
        .ni-tabs{background:var(--v2-surface-2);border-bottom:1px solid var(--v2-border);padding:0 24px;display:flex;gap:0;overflow-x:auto}
        ...
        .ni-sh{font-size:13px;font-weight:600;color:var(--v2-text);margin-bottom:10px;padding-bottom:6px;border-bottom:1px solid var(--v2-border)}
        .ni-p{font-size:13px;color:var(--v2-text-2);line-height:1.8;margin-bottom:10px}
        .pqc-card{background:var(--v2-surface);border:1px solid var(--v2-border);border-radius:var(--v2-r-xl);padding:14px 16px;margin-bottom:10px}
          ...
          <>
            ...
            {PQC_STANDARDS.map(s => (
              <div key={s.id} className="pqc-card">
                ...
                <div style={{ fontSize:14, fontWeight:600, color:'#111111', marginBottom:5 }}>{s.name}</div>
            ...
            {TIMELINE.map((e, i) => (
              <div key={e.year+i} className="tl-row">
                ...
                <div className="tl-spine">
                  <div className="tl-dot" style={{ background:'#f0f4fa' }}/>
