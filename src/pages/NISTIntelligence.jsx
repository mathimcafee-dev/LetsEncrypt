  ...
  return (
    <div className="v2-page" style={{ fontFamily: FONT }}>
      <style>{`
        ...
        .ni-h1 em{color:#f59e0b;font-style:normal}
        .ni-sub{font-size:13px;color:rgba(255,255,255,.5);max-width:680px;line-height:1.7;margin-bottom:20px}
        ...
        .ni-body{padding:20px 24px;max-width:900px}
