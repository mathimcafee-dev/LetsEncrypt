...
export default function NISTIntelligence({ nav }) {
  ...
  return (
    <div className="v2-page" style={{ fontFamily: FONT }}>
      <style>{`
        .ni-hero{background:transparent;padding:clamp(16px,4vw,32px) clamp(12px,3vw,24px) 28px;color:#f5f0eb}
        ...
        .ni-h1{font-size:26px;font-weight:600;letter-spacing:-.4px;color:#f5f0eb;line-height:1.15;margin-bottom:10px}
        ...
        .ni-sn{font-size:22px;font-weight:600;color:#f5f0eb;line-height:1}
