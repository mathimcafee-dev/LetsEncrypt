...
const EVENT_CONFIG = {
  issued:          { icon: ShieldCheck, color: '#ff8c7a', bg: 'rgba(42,107,92,0.09)', label: 'Certificate issued' },
  reissued:        { icon: RefreshCw,   color: '#ff8c7a', bg: 'rgba(42,107,92,0.09)', label: 'Certificate reissued' },
  renewed:         { icon: RotateCcw,   color: '#ff8c7a', bg: 'rgba(42,107,92,0.09)', label: 'Certificate renewed' },
  ...
  downloaded:      { icon: Download,    color: '#ff8c7a', bg: 'rgba(42,107,92,0.09)', label: 'Certificate downloaded' },
