...
const EVENT_CONFIG = {
  issued:          { icon: ShieldCheck, color: '#ff8c7a', bg: 'rgba(192,57,43,0.12)', label: 'Certificate issued' },
  reissued:        { icon: RefreshCw,   color: '#ff8c7a', bg: 'rgba(192,57,43,0.12)', label: 'Certificate reissued' },
