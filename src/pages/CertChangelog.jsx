...
const EVENT_CONFIG = {
  ...
  key_rotated:     { icon: RotateCcw,   color: '#e07060', bg: 'rgba(255,107,91,0.12)', label: 'Key rotated' },
  downloaded:      { icon: Download,    color: '#e07060', bg: 'rgba(192,57,43,0.12)', label: 'Certificate downloaded' },
  private_key_copied: { icon: Shield,   color: '#e07060', bg: 'rgba(255,107,91,0.12)', label: 'Private key copied' },
