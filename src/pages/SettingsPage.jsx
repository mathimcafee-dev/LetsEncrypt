    ...
    <div style={{ padding:'24px 28px 60px', fontFamily:"system-ui,-apple-system,'Segoe UI',sans-serif", maxWidth:680 }}>
      ...
      <Section title="Account">
        ...
        <Row label="Plan" desc="No payment required for sandbox and community use">
          <span style={{ fontSize:11, fontWeight:500, color:'#0369a1', background:'#eff6ff', border:'0.5px solid #bfdbfe', borderRadius:4, padding:'3px 8px' }}>Free</span>
        </Row>
      </Section>
      ...
      <Section title="Notifications">
        <Row label="Expiry alerts" desc="Get notified when certificates are within 30 days of expiry">
          <button
            ...
            style={{ width:36, height:20, borderRadius:10, border:'none', cursor:'pointer', background: emailAlerts ? '#0e7fc0' : '#e8edf2', position:'relative', transition:'background .15s', flexShrink:0 }}>
      ...
      <Section title="Security">
        ...
        <Row label="Private key storage" desc="Keys are stored encrypted at rest in your Supabase vault">
          <span style={{ fontSize:11, fontWeight:500, color:'#0369a1', display:'flex', alignItems:'center', gap:4 }}><Shield size={11}/> Encrypted</span>
        </Row>
      </Section>
      ...
      <div style={{ display:'flex', justifyContent:'flex-end' }}>
        <button onClick={handleSave} style={{ display:'inline-flex', alignItems:'center', gap:6, background:'#0e7fc0', color:'white', border:'none', borderRadius:6, padding:'9px 18px', fontSize:12, fontWeight:500, cursor:'pointer', fontFamily:'inherit' }}>
