...
const ENTROPY_COLORS = [
  '#16a068','#16a068','#86efac',
  '#9a6400','#f97316','#fb923c',
  '#1f5c4e','#ef4444','#fca5a5',
  '#818cf8','#a78bfa',
  '#38bdf8','#67e8f9',
  '#1f5c4e','#1f5c4e',
]
    ...
    <div style={{ border:'1px solid rgba(0,0,0,0.08)', borderRadius:10,
      ...
      {open && (
        <div style={{ borderTop:'0.5px solid rgba(0,0,0,0.05)', padding:'16px 16px 16px 20px' }}>
          ...
          <div style={{ background:'#f4f1ec', border:'0.5px solid rgba(0,0,0,0.06)',
          ...
          <div style={{ display:'grid', gridTemplateColumns:'repeat(3,1fr)', gap:8, marginBottom:14 }}>
            {[
              ...
              <div key={label} style={{ background:'rgba(0,0,0,0.03)',
                borderRadius:8, padding:'9px 12px', border:'0.5px solid rgba(0,0,0,0.05)' }}>
