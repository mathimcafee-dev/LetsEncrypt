...
export default function IETFIntelligence({ nav }) {
  ...
  return (
    <div className="v2-page" style={{ fontFamily: FONT }}>
      <style>{`
        .ii-hero{background:transparent;padding:clamp(16px,4vw,32px) clamp(12px,3vw,24px) 28px;color:#ffffff}
        ...
        .ii-h1{font-size:26px;font-weight:600;letter-spacing:-.4px;color:#ffffff;line-height:1.15;margin-bottom:10px}
        .ii-h1 em{color:#2a6b5c;font-style:normal}
        ...
        .ii-sn{font-size:22px;font-weight:600;color:#ffffff;line-height:1}
        .ii-sl{font-size:10px;color:rgba(255,255,255,.35);margin-top:3px;letter-spacing:.05em;text-transform:uppercase}
        .ii-tabs{background:var(--v2-surface-2);border-bottom:1px solid var(--v2-border);padding:0 24px;display:flex;gap:0;overflow-x:auto}
        ...
        .ii-sh{font-size:13px;font-weight:600;color:var(--v2-text);margin-bottom:10px;padding-bottom:6px;border-bottom:1px solid var(--v2-border)}
        .ii-p{font-size:13px;color:var(--v2-text-2);line-height:1.8;margin-bottom:10px}
        .rfc-card{background:var(--v2-surface);border:1px solid var(--v2-border);border-radius:var(--v2-r-xl);padding:14px 16px;margin-bottom:10px}
        .wg-card{background:var(--v2-surface);border:1px solid var(--v2-border);border-radius:var(--v2-r-xl);padding:14px 16px;margin-bottom:10px}
