...
const PILLARS = [
  { icon: Shield,    color:'#10b981', title:'Issue',   sub:'RapidSSL DV via TheSSLStore · DigiCert chain · ~5 min issuance' },
      ...
      <section style={{ background:'#0a0a0a', padding:'80px 24px 72px', position:'relative', overflow:'hidden' }}>
        ...
        <div style={{ maxWidth:1100, margin:'0 auto', position:'relative' }}>
          ...
          <div style={{ display:'inline-flex', alignItems:'center', gap:7, background:'rgba(16,185,129,0.1)', border:'1px solid rgba(16,185,129,0.25)', borderRadius:100, padding:'5px 14px', marginBottom:28 }}>
            <span style={{ width:6, height:6, borderRadius:'50%', background:'#10b981', display:'block', boxShadow:'0 0 0 2px rgba(16,185,129,0.3)' }}/>
            <span style={{ fontSize:11, fontWeight:600, color:'#34d399', letterSpacing:'0.2px' }}>Certificate Lifecycle Management Platform</span>
          </div>
          ...
          <div style={{ display:'grid', gridTemplateColumns:'1fr 420px', gap:64, alignItems:'center' }}>
            ...
            <div>
              ...
              <h1 style={{ fontSize:'clamp(36px,4.5vw,54px)', fontWeight:800, color:'#10b981', lineHeight:1.1, letterSpacing:'-1.5px', margin:'0 0 24px' }}>
                One platform.
              </h1>
              ...
              <div style={{ display:'flex', gap:12, flexWrap:'wrap', marginBottom:32 }}>
                <button onClick={() => nav('/buy')}
                  style={{ background:'#10b981', color:'white', border:'none', borderRadius:8, padding:'12px 24px', fontSize:14, fontWeight:700, cursor:'pointer', display:'inline-flex', alignItems:'center', gap:8, fontFamily:'inherit', boxShadow:'0 4px 16px rgba(16,185,129,0.35)' }}>
            ...
            <div style={{ display:'flex', flexDirection:'column', gap:8 }}>
              {/* Active cert */}
              <div style={{ background:'#111827', border:'1px solid rgba(255,255,255,0.06)', borderRadius:12, padding:'16px 18px', borderLeft:'3px solid #10b981' }}>
                <div style={{ display:'flex', justifyContent:'space-between', alignItems:'flex-start', marginBottom:12 }}>
                  ...
                  <div style={{ display:'flex', alignItems:'center', gap:5, background:'rgba(16,185,129,0.1)', border:'1px solid rgba(16,185,129,0.2)', borderRadius:100, padding:'3px 9px' }}>
                    ...
                    <span style={{ fontSize:10, color:'#34d399', fontWeight:600 }}>Valid · 89d</span>
                  </div>
                </div>
                <div style={{ height:3, background:'rgba(255,255,255,0.06)', borderRadius:100, overflow:'hidden' }}>
                  <div style={{ width:'75%', height:'100%', background:'linear-gradient(90deg,#10b981,#34d399)', borderRadius:100 }}/>
                </div>
              ...
              <div style={{ background:'rgba(16,185,129,0.05)', border:'1px solid rgba(16,185,129,0.15)', borderRadius:10, padding:'11px 14px', display:'flex', alignItems:'center', gap:10 }}>
                ...
                <div>
                  <div style={{ fontSize:11, fontWeight:600, color:'#34d399' }}>Auto-renewal active</div>
      ...
      <section style={{ background:'white', borderBottom:'0.5px solid #f0f0f0' }}>
        <div style={{ maxWidth:1100, margin:'0 auto' }}>
          <div style={{ display:'grid', gridTemplateColumns:'repeat(4,1fr)' }}>
            {[
              { v: count != null ? count.toLocaleString() : '100+', l:'Certificates managed', c:'#10b981' },
          ...
          <div style={{ background:'#0d1117', borderRadius:14, overflow:'hidden', border:'1px solid #21262d' }}>
            ...
            <div style={{ padding:'10px 16px', background:'#161b22', borderBottom:'1px solid #21262d', display:'flex', alignItems:'center', gap:8 }}>
              <div style={{ display:'flex', gap:5 }}>
                {['#ff5f56','#ffbd2e','#27c93f'].map(c => <span key={c} style={{ width:10, height:10, borderRadius:'50%', background:c, display:'block' }}/>)}
              </div>
              <span style={{ fontSize:11, color:'#484f58', fontFamily:'monospace', marginLeft:4 }}>certificate-workflow.sh</span>
            </div>
            <div style={{ padding:'36px 40px' }}>
              <div style={{ fontSize:11, color:'#10b981', fontFamily:'monospace', letterSpacing:'0.5px', marginBottom:32 }}>
              ...
              <div style={{ display:'grid', gridTemplateColumns:'repeat(4,1fr)', gap:20, position:'relative' }}>
                ...
                {[
                  { n:'01', color:'#10b981', label:'Issue', desc:'Place order via TheSSLStore · DNS DV auto-validated · Cert issued in ~5 min' },
              ...
              <div style={{ marginTop:36, paddingTop:28, borderTop:'1px solid #21262d', display:'flex', justifyContent:'space-between', alignItems:'center', flexWrap:'wrap', gap:12 }}>
                ...
                <button onClick={() => nav('/buy')}
                  style={{ background:'#10b981', color:'white', border:'none', borderRadius:7, padding:'10px 20px', fontSize:13, fontWeight:700, cursor:'pointer', display:'inline-flex', alignItems:'center', gap:7, fontFamily:'inherit' }}>
          ...
          <div style={{ background:'#0a0a0a', borderRadius:16, padding:'56px 48px', textAlign:'center', position:'relative', overflow:'hidden' }}>
            ...
            <div style={{ position:'relative' }}>
              ...
              <div style={{ display:'flex', gap:10, justifyContent:'center', flexWrap:'wrap' }}>
                <button onClick={() => nav('/buy')} style={{ background:'#10b981', color:'white', border:'none', borderRadius:8, padding:'12px 24px', fontSize:13, fontWeight:700, cursor:'pointer', display:'inline-flex', alignItems:'center', gap:7, fontFamily:'inherit', boxShadow:'0 4px 16px rgba(16,185,129,0.3)' }}>
          ...
          <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr 1fr 1fr', gap:32, marginBottom:32 }}>
            <div>
              <div style={{ display:'flex', alignItems:'center', gap:8, marginBottom:12 }}>
                ...
                <span style={{ fontSize:14, fontWeight:700, color:'#0a0a0a' }}>SSL<span style={{ color:'#10b981' }}>Vault</span></span>
              </div>
