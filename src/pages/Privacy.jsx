        ...
        <div style={{maxWidth:820,margin:'0 auto',padding:'0 24px'}}>
          <div style={{background:'white',borderRadius:24,padding:'48px 50px',boxShadow:'0 4px 24px rgba(15,23,42,0.06)',border:'1px solid #e2e8f0'}}>
            ...
            <Section title='2. What we collect'>
              ...
              <p style={p}><strong>Private keys — KeyLocker Pro:</strong> private keys are encrypted using AES-256-GCM envelope encryption before storage. A per-certificate Data Encryption Key (DEK) is generated at issuance time and wrapped with a Master Key (KEK) stored separately in a secure secrets vault — not in the database. This means the database alone contains only ciphertext, which is cryptographically useless without the KEK. Every key access is permanently recorded in an immutable audit log. SSLVault is committed to continuously raising the security standard of key storage, with zero-knowledge architecture on our roadmap.</p>
