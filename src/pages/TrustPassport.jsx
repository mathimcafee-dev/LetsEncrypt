        ...
        <div style={{ background:'white', border:'0.5px solid var(--v2-border-strong)', borderRadius:12, padding:'14px 16px', marginBottom:4 }}>
          <div style={{ display:'flex', gap:10, alignItems:'center' }}>
            ...
            <button onClick={() => check()}
              disabled={loading}
              style={{ display:'flex', alignItems:'center', gap:7, background:'#0a0a0a', color:'white', border:'none',
          ...
          <div className="verdict-card" style={{ background: v.bg, border: `1.5px solid ${v.border}` }}>
            ...
            <div style={{ flex:1, minWidth:0 }}>
              <div style={{ display:'flex', alignItems:'center', gap:10, marginBottom:6, flexWrap:'wrap' }}>
                ...
                <span style={{ fontSize:12, fontWeight:600, padding:'3px 10px', borderRadius:20, background:v.color, color:'white' }}>{v.label}</span>
              </div>
