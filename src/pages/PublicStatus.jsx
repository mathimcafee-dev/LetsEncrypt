...
export default function PublicStatus({ username: propUsername, nav }) {
  ...
  const overallColor  = allHealthy ? '#16a34a' : hasIssues ? '#dc2626' : '#f07059'
  const overallBg     = allHealthy ? '#ccfbf1'  : hasIssues ? '#fef2f2' : '#fde8e4'
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#f0fdf9' }}>
      {/* Nav */}
      <div style={{ background: '#fff', borderBottom: '0.5px solid #99f6e4',
        ...
        <span style={{ fontSize:11, color: 'rgba(0,0,0,0.36)' }}>
          Powered by <a href="https://easysecurity.in" target="_blank" rel="noreferrer"
            style={{ color: '#0d9488', textDecoration: 'none' }}>easysecurity.in</a>
        </span>
      </div>
      ...
      <div style={{ maxWidth: 680, margin: '0 auto', padding:'min(40px,5vw) min(24px,4vw)' }}>
        ...
        {loading ? (
          <div style={{ textAlign: 'center', padding: '60px 0', color: 'rgba(0,0,0,0.36)' }}>
          ...
          <div style={{ textAlign: 'center', padding: '60px 0' }}>
            ...
            <div style={{ fontSize:13, color: 'rgba(0,0,0,0.36)' }}>This status page may not be public or doesn't exist.</div>
          </div>
        ) : (
          <>
            {/* Header */}
            <div style={{ marginBottom: 28 }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 12 }}>
                <div style={{ width: 44, height: 44, borderRadius: 12, background: '#ccfbf1',
                ...
                <div>
                  ...
                  <div style={{ fontSize:12, color: 'rgba(0,0,0,0.36)' }}>SSL status page</div>
                </div>
              </div>
              ...
              <div style={{ background: overallBg, border: `0.5px solid ${overallColor}33`,
                ...
                <div style={{ marginLeft: 'auto', fontSize:11, color: 'rgba(0,0,0,0.36)' }}>
            ...
            {/* Domain list */}
            {scores.length === 0 ? (
              <div style={{ textAlign: 'center', padding: '32px 0', fontSize:13, color: 'rgba(0,0,0,0.36)' }}>
                  ...
                  return (
                    <div key={s.domain} style={{ background: '#fff', border: `0.5px solid ${gs.border}`,
                      ...
                      <div style={{ width: 10, height: 10, borderRadius: '50%', flexShrink: 0,
                        background: domainHealthy ? '#16a34a' : s.expiry_days != null && s.expiry_days <= 7 ? '#dc2626' : '#f07059',
                      ...
                      <div style={{ flex: 1, minWidth: 0 }}>
                        <div style={{ fontSize:13, fontWeight: 500, color: '#0a0a0a',
                          ...
                          <a href={`https://${s.domain}`} target="_blank" rel="noreferrer"
                            style={{ color: 'rgba(0,0,0,0.36)', display: 'flex' }}
                        ...
                        <div style={{ display: 'flex', gap: 12, marginTop: 3 }}>
                          ...
                          {s.expiry_days != null && (
                            <span style={{ fontSize:11, fontWeight: 500,
                              color: s.expiry_days <= 7 ? '#dc2626' : s.expiry_days <= 30 ? '#f07059' : '#16a34a' }}>
            ...
            <div style={{ textAlign: 'center', marginTop: 32 }}>
              <a href="https://easysecurity.in" target="_blank" rel="noreferrer"
                style={{ fontSize:12, color: 'rgba(0,0,0,0.36)', textDecoration: 'none',
