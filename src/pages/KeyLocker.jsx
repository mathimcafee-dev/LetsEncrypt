...
function RevealModal({ keyEntry, userEmail, onClose }) {
  ...
  return (
    <div style={{ position:'fixed', inset:0, background:'#444444', zIndex:300,
      ...
      <div style={{ background:'var(--v2-surface)', borderRadius:14, width:'100%', maxWidth:480,
        ...
        <div style={{ padding:'16px 20px', borderBottom:'1px solid rgba(0,0,0,0.06)',
          ...
          <button onClick={onClose} style={{ background:'none', border:'none',
            cursor:'pointer', color:'#555555', fontSize:20, lineHeight:1, padding:'2px 4px' }}>
            ×
          </button>
        </div>
        ...
        <div style={{ height:2, background:'var(--v2-surface-3)', display:'flex' }}>
          {step === 'auth' ? (
            <div style={{ width:'50%', background:'#f0f4fa', transition:'width .3s' }}/>
          ) : (
            <div style={{ width:`${pct}%`, background:'#f0f4fa', transition:'width 1s linear' }}/>
          )}
        </div>
        ...
        <div style={{ padding:'16px 20px 20px' }}>
            ...
            <form onSubmit={verifyPassword}>
              ...
              <div style={{ marginBottom:12 }}>
                <label style={{ fontSize:11, fontWeight:600, color:'#333333',
                  ...
                  Account password
                  <span style={{ fontSize:10, color:'#555555', fontWeight:400,
          ...
          {step === 'key' && (
            <>
              {loading ? (
                <div style={{ textAlign:'center', padding:'28px 0', color:'#555555' }}>
                ...
                <>
                  ...
                  <div style={{ background:'#f0f4fa', borderRadius:9, padding:'14px 16px',
                    marginBottom:12, fontFamily:'monospace', fontSize:11, color:'#555555',
                  ...
                  <div style={{ fontSize:10, color:'#555555', textAlign:'center', marginTop:8 }}>
  ...
  return (
    <div style={{ display:'flex', alignItems:'center', gap:12, padding:'10px 16px',
      ...
      <div style={{ flex:1, minWidth:0 }}>
        ...
        <span style={{ color:'#555555', marginLeft:8 }}>
          {entry.action} · via {entry.triggered_by}
        </span>
      </div>
      <div style={{ fontSize:11, color:'#555555', flexShrink:0 }}>
...
function KeyCard({ keyEntry, onRotate, rotating, onReveal, onViewAudit }) {
  ...
  return (
    <div style={{ border:`1px solid var(--v2-border)`, borderRadius:10, overflow:'hidden',
      ...
      <div style={{ padding:'16px 18px' }}>
        ...
        <div style={{ display:'flex', alignItems:'flex-start', justifyContent:'space-between',
          ...
          <div style={{ minWidth:0 }}>
            <div style={{ display:'flex', alignItems:'center', gap:8, marginBottom:4, flexWrap:'wrap' }}>
              <span style={{ fontSize:13, fontWeight:600, color:'#111111', fontFamily:'"JetBrains Mono",monospace' }}>
                {keyEntry.domain}
              </span>
              ...
              {keyEntry.status === 'active' && keyEntry.cert_status === 'active' && (
                <span style={{ display:'inline-flex', alignItems:'center', gap:4, fontSize:9,
                  color:'#111111', background:'rgba(124,58,237,0.07)',
                  border:'1px solid rgba(124,58,237,0.2)', borderRadius:4, padding:'1px 7px', fontWeight:700 }}>
              ...
              {keyEntry.cert_status && keyEntry.cert_status !== 'active' && (
                <span style={{ fontSize:9, fontWeight:700, textTransform:'uppercase', letterSpacing:'0.3px',
                  color: keyEntry.cert_status === 'cancelled' ? '#0091d6' : '#0077b6',
                  background: keyEntry.cert_status === 'cancelled' ? 'rgba(0,119,182,0.08)' : 'rgba(230,126,34,0.12)',
        ...
        {isExpiringSoon && keyEntry.status === 'active' && (
          <div style={{ background:'rgba(239,68,68,0.08)', border:'1px solid rgba(154,100,0,0.2)', borderRadius:8,
            padding:'10px 12px', marginBottom:12, fontSize:11, color:'#0077b6' }}>
        ...
        <div style={{ display:'grid', gridTemplateColumns:'repeat(auto-fill,minmax(180px,1fr))', gap:8, marginBottom:14 }}>
          {[
            ...
            <div key={label} style={{ background:'var(--v2-surface-3)', borderRadius:7,
              ...
              <div style={{ fontSize:9, fontWeight:600, color:'#555555',
        ...
        {keyEntry.status === 'active' && (
          <div style={{ display:'flex', gap:7, flexWrap:'wrap' }}>
            ...
            <button style={{display:'inline-flex',alignItems:'center',gap:5,padding:'5px 11px',borderRadius:6,border:'1px solid rgba(0,0,0,0.15)',background:'#ffffff',color:'#444444',fontSize:11,fontWeight:600,cursor:'pointer',fontFamily:'inherit',transition:'all .15s'}} onClick={() => onRotate(keyEntry)}
              ...
              style={{ display:'flex', alignItems:'center', gap:5, fontSize:11, color:'rgba(240,237,232,0.85)', border:'1px solid #bbbbbb' }}>
        ...
        {keyEntry.status === 'archived' && (
          <div style={{ display:'flex', alignItems:'center', gap:8 }}>
            <div style={{ fontSize:11, color:'#555555', flex:1 }}>
            ...
            {tab === 'vault' && (
              activeKeys.length === 0 ? (
                <div style={{ textAlign:'center', padding:'48px 0' }}>
                  ...
                  <div style={{ fontSize:12, color:'#555555', maxWidth:360,
