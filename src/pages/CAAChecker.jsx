  ...
  return (
    <div className="v2-page">
      <div className="v2-container" style={{ maxWidth:760 }}>
        ...
        {/* Input */}
        <div style={{ background:'white', border:'0.5px solid var(--v2-border)', borderRadius:10, padding:'16px 18px', marginBottom:16 }}>
        ...
        {result && (
          <div style={{ animation:'fadeSlideUp 0.3s ease both' }}>
            ...
            {/* Checks list */}
            <div style={{ background:'white', border:'0.5px solid var(--v2-border)', borderRadius:10, overflow:'hidden', marginBottom:16 }}>
