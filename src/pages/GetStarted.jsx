        ...
        <Step n={3} title="Complete domain validation (DCV)">
          ...
          <div style={{ background: '#f0ede8', borderRadius: 8, padding: '12px 16px', marginBottom: 10 }}>
            <div style={{ display: 'grid', gridTemplateColumns: '80px 1fr', gap: '6px 14px', fontFamily: 'JetBrains Mono, monospace', fontSize:12 }}>
              <span style={{ color: 'rgba(240,237,232,0.7)', fontWeight: 600 }}>TYPE</span><span style={{ color: '#f0ede8' }}>CNAME</span>
              <span style={{ color: 'rgba(240,237,232,0.7)', fontWeight: 600 }}>NAME</span><span style={{ color: '#e07060' }}>_acme-challenge</span>
              <span style={{ color: 'rgba(240,237,232,0.7)', fontWeight: 600 }}>VALUE</span><span style={{ color: '#fbbf24', wordBreak: 'break-all' }}>abc123def456.comodoca.com</span>
            </div>
          </div>
