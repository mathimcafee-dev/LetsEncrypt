...
const PILLARS = [
  { icon: Lock, title: 'Free issuance', body: 'DV certificates via TheSSLStore and DigiCert. RapidSSL certs issued in minutes, no credit card required for sandbox testing.' },
    ...
    <div style={{ padding:'28px 28px 60px', fontFamily:"system-ui,-apple-system,'Segoe UI',sans-serif" }}>
      ...
      <div style={{ background:'white', border:'0.5px solid #e8edf2', borderRadius:8, padding:'28px 32px', marginBottom:16, borderLeft:'3px solid #10b981' }}>
        ...
        <p style={{ fontSize:13, color:'#525252', lineHeight:1.8, margin:'0 0 10px', maxWidth:720 }}>
          SSLVault is a certificate lifecycle management platform built on top of commercial CAs (TheSSLStore, DigiCert) and designed for indie developers, SMBs, and non-profits who need enterprise-grade SSL management without enterprise pricing.
        </p>
      ...
      <div style={{ display:'grid', gridTemplateColumns:'repeat(2,1fr)', gap:12, marginBottom:16 }}>
        {PILLARS.map(({ icon:Icon, title, body }) => (
          <div key={title} style={{ background:'white', border:'0.5px solid #e8edf2', borderRadius:8, padding:'20px 22px' }}>
            <div style={{ width:32, height:32, background:'#f0fdf4', border:'0.5px solid #bbf7d0', borderRadius:7, display:'flex', alignItems:'center', justifyContent:'center', marginBottom:12 }}>
      ...
      <div style={{ background:'white', border:'0.5px solid #e8edf2', borderRadius:8, padding:'20px 24px', marginBottom:16 }}>
        ...
        <div style={{ display:'grid', gridTemplateColumns:'repeat(3,1fr)', gap:8 }}>
          {[
            ...
            ['Hosting', 'Vercel'],
            ['CA Partner', 'TheSSLStore · DigiCert'],
      ...
      <div style={{ display:'flex', gap:10 }}>
        <button onClick={() => nav('/developer')} style={{ display:'inline-flex', alignItems:'center', gap:6, background:'#10b981', color:'white', border:'none', borderRadius:6, padding:'9px 16px', fontSize:12, fontWeight:500, cursor:'pointer', fontFamily:'inherit' }}>
