...
const PROVIDERS = {
  ...
  namecheap: {
    name: 'Namecheap', mono: 'NC', color: '#0077b6',
    fields: [
  ...
  porkbun: {
    name: 'Porkbun', mono: 'PB', color: '#0077b6',
    fields: [
  ...
  gandi: {
    name: 'Gandi', mono: 'GA', color: '#0077b6',
    fields: [
  ...
  hetzner: {
    name: 'Hetzner DNS', mono: 'HZ', color: '#0077b6',
    fields: [
  ...
  linode: {
    name: 'Linode / Akamai', mono: 'LN', color: '#5edb8a',
    fields: [
  ...
  vultr: {
    name: 'Vultr', mono: 'VU', color: '#0077b6',
    fields: [
  ...
  bunny: {
    name: 'Bunny DNS', mono: 'BN', color: '#0077b6',
    fields: [
  ...
  dnsimple: {
    name: 'DNSimple', mono: 'DS', color: '#5edb8a',
    fields: [
  ...
  return (
    <div style={{ background:'rgba(0,0,0,0.02)', border:'1px solid var(--v2-border)',
      ...
      <div style={{ display: 'flex', gap: 6, paddingTop: 12, borderTop: '1px solid var(--v2-border)' }}>
        ...
        {agent && (
          <button className="v2-btn" style={{ color: '#0077b6', borderColor: 'rgba(239,83,80,0.3)' }}
      ...
      {showRemoveAgent && (
        <div style={{
          position: 'fixed', inset: 0, background: '#666666', zIndex: 9999,
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 16 }}>
              <div style={{ width: 36, height: 36, borderRadius: 8, background: 'rgba(0,119,182,0.09)',
                ...
                <WifiOff size={18} strokeWidth={1.8} color="#0077b6" />
              </div>
              <div>
                <div style={{ fontSize:14, fontWeight: 600, color: '#111111' }}>Remove agent from server</div>
                <div style={{ fontSize:11, color: '#888888' }}>{server.nickname} · {server.host}</div>
              </div>
            </div>

            {/* Step 1 — server command */}
            <div style={{ marginBottom: 16 }}>
              <div style={{ fontSize:11, fontWeight: 600, color: '#333333', marginBottom: 6, textTransform: 'uppercase', letterSpacing: '0.05em' }}>
                Step 1 — Run on your server
              </div>
              <div style={{ background:'#f0f4fa', borderRadius: 8, padding: '10px 14px', position: 'relative' }}>
            ...
            <div style={{ marginBottom: 20 }}>
              ...
              <div style={{ fontSize:12, color: '#333333', lineHeight: 1.5 }}>
              ...
              <div style={{ display: 'flex', gap: 8 }}>
                ...
                <button
                  ...
                  style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6,
                    background: '#0077b6', color: '#111111', border: 'none', borderRadius: 8,
      ...
      <div style={{ maxWidth:1140, margin:'0 auto', padding:'28px 24px 80px' }}>
        ...
        <div style={{ display:'grid', gridTemplateColumns:'minmax(0,1.5fr) minmax(0,1fr)', gap:16, marginTop:4 }}>
          ...
          <div>
            {loading ? (
              <ListPanel>
                <div style={{ padding:'clamp(16px,16vw,48px) 16px', textAlign:'center', fontSize:12, color:'#888888' }}>
                  <RefreshCw size={18} style={{ color:'#888888', animation:'spin 1s linear infinite', marginBottom:10, display:'block', margin:'0 auto 10px' }}/>
                  Loading domains…
                </div>
              </ListPanel>
              ...
              <div style={{ display:'flex', flexDirection:'column', gap:12 }}>
                ...
                {domainGroups.filter(g => g.dns && g.server).length > 0 && (
                  <ListPanel>
                    <SectionLabel label="DNS + Server · Full automation" icon={Zap} color="#0091d6"
                ...
                {domainGroups.filter(g => !g.dns && g.server).length > 0 && (
                  <ListPanel>
                    <SectionLabel label="Server Only" icon={Server} color="#0077b6"
                      count={domainGroups.filter(g=>!g.dns&&g.server).length}/>
                    <div style={{ padding:'8px 10px 10px' }}>
                      {domainGroups.filter(g => !g.dns && g.server).map(g => (
                        <DomainRow key={g.domain} group={g}
          ...
          <div>
            {selGroup ? (
              ...
              <div className="v2-detail" style={{ textAlign: 'center', padding:'min(40px,5vw) min(16px,4vw)' }}>
                <div style={{ fontSize:12, color: '#333333' }}>Select a domain to see details</div>
              </div>
            ) : null}
          </div>
        </div>
