...
function agentStatus(last_seen_at, status) {
  ...
  return { label: 'Online', color: '#047857', dot: '#10b981', bg: '#f0fdf4' }
}
...
function InstallModal({ onClose }) {
  ...
  const CmdBlock = ({ cmd, id }) => (
    <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', background:'#0a0a0a', borderRadius:6, padding:'10px 14px', marginBottom:8 }}>
      <code style={{ fontSize:12, color:'#10b981', fontFamily:"'SF Mono',monospace", flex:1, overflow:'auto' }}>{cmd}</code>
    ...
    <div style={{ position:'fixed', inset:0, background:'rgba(0,0,0,0.4)', zIndex:200, display:'flex', alignItems:'center', justifyContent:'center', padding:24 }}>
      <div style={{ background:'white', borderRadius:10, width:'100%', maxWidth:540, boxShadow:'0 20px 60px rgba(0,0,0,0.2)', overflow:'hidden' }}>
        ...
        <div style={{ padding:'20px 22px' }}>
          ...
          <div style={{ background:'#f0fdf4', border:'0.5px solid #bbf7d0', borderRadius:6, padding:'10px 12px', marginTop:14 }}>
    ...
    <div style={{ padding:'24px 28px 60px' }}>
      ...
      <div style={{ display:'flex', alignItems:'flex-start', justifyContent:'space-between', marginBottom:24, gap:16 }}>
        <div>
          <div style={{ fontSize:14, color:'#525252', marginBottom:2 }}>
            ...
            {!loading && online > 0 && <span style={{ marginLeft:8, fontSize:11, color:'#047857', fontWeight:500 }}>· {online} online</span>}
          </div>
        ...
        <div style={{ display:'flex', gap:8, flexShrink:0 }}>
          ...
          <button onClick={() => setShowInstall(true)} style={{ display:'inline-flex', alignItems:'center', gap:6, background:'#10b981', color:'white', border:'none', padding:'7px 14px', borderRadius:6, fontSize:12, fontWeight:500, cursor:'pointer', fontFamily:'inherit' }}>
      ...
      {!loading && agents.length > 0 && (
        <div style={{ display:'grid', gridTemplateColumns:'repeat(3,1fr)', gap:12, marginBottom:24 }}>
          {[
            ...
            { label:'Online now', val:online, color: online > 0 ? '#047857' : '#0a0a0a' },
      ...
      {loading ? (
        ...
        <div style={{ background:'white', border:'0.5px solid #e8edf2', borderRadius:8, padding:'60px 20px', textAlign:'center' }}>
          ...
          <button onClick={() => setShowInstall(true)} style={{ display:'inline-flex', alignItems:'center', gap:6, background:'#10b981', color:'white', border:'none', borderRadius:6, padding:'9px 18px', fontSize:12, fontWeight:500, cursor:'pointer', fontFamily:'inherit' }}>
