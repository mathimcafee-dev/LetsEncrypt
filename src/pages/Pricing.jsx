        ...
        <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:20, marginBottom:48 }}>
          ...
          <div style={{ background:'#0a0a0a', border:'0.5px solid #1a1a1a',
            ...
            <div style={{ flex:1, display:'flex', flexDirection:'column', gap:10, marginBottom:24 }}>
              {paidPros.map(item => (
                <div key={item} style={{ display:'flex', alignItems:'center', gap:10 }}>
                  <CheckCircle size={14} color="#0e7fc0" style={{ flexShrink:0 }}/>
          ...
          <table style={{ width:'100%', borderCollapse:'collapse', fontSize:13 }}>
            <thead>
              <tr style={{ background:'var(--v2-surface)' }}>
                ...
                <th style={{ padding:'12px 16px', textAlign:'center', fontWeight:700, color:'#0e7fc0',
            ...
            <tbody>
              {[
                ...
                <tr key={feat} style={{ borderTop:'0.5px solid var(--v2-border)',
                  ...
                  <td style={{ padding:'11px 16px', textAlign:'center',
                    color: paid==='✓'?'#0e7fc0':'var(--v2-text-3)', fontWeight: paid==='✓'?700:400 }}>{paid}</td>
                </tr>
              ))}
            </tbody>
          </table>
