...
function Step({ n, title, children }) {
  return (
    <div style={{ display:'flex', gap:16, marginBottom:22 }}>
      <div style={{ width:28, height:28, borderRadius:8, background:C.teal, color:'#111111', display:'flex', alignItems:'center', justifyContent:'center', fontSize:12, fontWeight:700, flexShrink:0, marginTop:1 }}>{n}</div>
      <div style={{ flex:1 }}>
      ...
      "headers": {
        ...
        <div style={{ marginTop:48, padding:'24px 28px', background:C.tealBg, border:`1px solid ${C.tealBd}`, borderRadius:12, display:'flex', alignItems:'center', justifyContent:'space-between', flexWrap:'wrap', gap:16 }}>
          ...
          <div style={{ display:'flex', gap:10 }}>
            ...
            <button onClick={() => window.location.href='mailto:mathimcafee@gmail.com'} style={{ background:C.teal, border:'none', cursor:'pointer', fontFamily:F, fontSize:13, fontWeight:600, color:'#111111', padding:'8px 18px', borderRadius:100 }}>Contact support</button>
          </div>
        </div>
